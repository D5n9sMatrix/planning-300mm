...
class MyTestCase(unittest.TestCase):
    ...
    def length_hint(*args, **kwargs):  # real signature unknown
        ...
        This is useful for resizing containers when building from an iterable.
    ...
    def truth(*args, **kwargs):  # real signature unknown
        """ Return True if an is true, False otherwise. """
        pass
    ...
    class attrgetter(object):
        ...
        def __init__(self, attr):  # real signature unknown; restored from __doc__
            self.attr = attr
    ...
    class itemgetter(object):
        ...
        def __init__(self, item):  # real signature unknown; restored from __doc__
            self.item = item
